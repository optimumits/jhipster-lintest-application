...
import com.optimumits.lintest.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.optimumits.lintest.domain.Article}.
 */
@RestController
@RequestMapping("/api")
public class ArticleResource {
    ...
    private static final String ENTITY_NAME = "jhipsterLinTestApplicationArticle";
